...
document.addEventListener("DOMContentLoaded", () => {
  ...
  console.log("ism element:", ism);
  console.log("tel element:", tel);
  console.log("tarif element:", tarif);
  ...
  if (!tarif) {
    console.error("Error: Element with class 'tarif' not found");
    return;
  }
  ...
  tarif.textContent = formData.type;
});